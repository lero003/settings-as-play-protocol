...
Settings as Play Protocol, or SaPP, is a lightweight Markdown-based protocol for sharing the core of character settings, worldbuilding, prompts, play rules, derivation, and credit.
...
- [Example: Tiny SaPP Cards](examples/tiny/rain-singing-lighthouse.md)
