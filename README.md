...
これから、AIによるインスタントなエンタメ生成はもっと増えていくはずです。

そのとき、キャラクター、世界観、プロンプト、遊び方が、大きなサービスや閉じた市場の中だけに囲い込まれていく未来もありえます。けれど、それだけでは少しつまらない。

SaPP は、設定を独占するためではなく、誰かの設定が別の誰かの遊びの種になり、由来を残しながら受け渡されていく未来のための小さな形式です。

もちろん、権利侵害や無断利用をこの形式だけで防ぐことはできません。それは法と倫理の問題として扱う必要があります。

SaPP が目指すのは、許諾されたもの、共有してよいもの、派生を歓迎するものが、もっと気持ちよく受け渡される社会です。

設定を囲い込むだけでなく、贈り合い、育て合い、細くつながっていくために。
